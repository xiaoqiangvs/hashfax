...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?=Url::toRoute('article/index')?>">公告管理</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>公告编辑</span>
...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> 公告编辑
    <small>发布 & 编辑</small>
</h3>
<!-- BEGIN PAGE BASE CONTENT -->
<div class="row">
    <form action="#" id="saveForm" method="post" data-save="<?=Url::toRoute("notice/update")?>" data-rec="<?=Url::toRoute("notice/index")?>" class="form-horizontal" enctype="multipart/form-data">
        <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <input type="text" name="notice_title" maxlength="50" class="form-control" value="<?php if($attr){echo $attr['notice_title'];}?>"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="input-icon right">
                                <i class="fa"></i>
                                <input type="text" name="notice_author" maxlength="50" class="form-control input-medium" value="<?php if($attr){echo $attr['notice_author'];}?>"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group last">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-icon right">
                                <i class="fa"></i>
                            <script type="text/plain" id="notice_content" name="notice_content" style="width:100%;height:240px;">
                                 <?php if($attr){echo $attr['notice_content'];} ?>
                            </script>
                            </div>
                        </div>
                    </div>
        ...
        <div class="form-actions">
            <div class="row">
                <div class="col-md-offset-1 col-md-9">
                    ...
                    <input class='hide' type="text" name="notice_id" value="<?php if($attr){echo $attr['notice_id'];}?>"/>
...
<script type="text/javascript">
    ...
    var initEditor = function(){
        var um = UM.getEditor('notice_content',{
            imageUrl: "<?=Url::toRoute("notice/upload")?>",
            imagePath: "<?=$imghost?>",
            imageFieldName: "file"
        });
    }
